          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="flex flex-col items-center gap-3 pt-1">
              ...
              >
                <Button
                  variant="outline"
                  className="w-full font-semibold text-violet-600 hover:text-violet-700 hover:bg-violet-50 border-border gap-2"
                >
                  <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.929 3.477 1.674 3.477 2.735 0 1.06-.95 1.674-2.475 1.674-1.858 0-4.215-.875-6.012-2.058l-.96 5.587C6.368 23.888 9.445 24 11.868 24c2.59 0 4.74-.637 6.271-1.849 1.614-1.272 2.475-3.234 2.475-5.599 0-4.098-2.565-5.787-6.638-7.402z" fill="#635BFF" />
                  </svg>
                  Stripe
                </Button>
              </a>
              <p className="text-xs text-muted-foreground text-center leading-snug">
                Track pending payouts, payout dates, and bank deposits.
              </p>
            </CardContent>
          </Card>
        </div>
